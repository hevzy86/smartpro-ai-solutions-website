        ...
        <div className="w-full flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 justify-center order-3 sm:order-2">
            <a href="https://www.linkedin.com/company/108030490/admin/dashboard/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <Image src="/icons/socials/4102586_applications_linkedin_social_social media_icon.png" alt="LinkedIn" width={36} height={36} className="hover:scale-110 transition-transform duration-200" unoptimized />
            </a>
            <a href="https://www.instagram.com/hevzy86/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <Image src="/icons/socials/6929237_instagram_icon.png" alt="Instagram" width={36} height={36} className="hover:scale-110 transition-transform duration-200" unoptimized />
            </a>
            <a href="https://www.youtube.com/@SmartProAiSolutions" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <Image src="/icons/socials/317714_video_youtube_icon.png" alt="YouTube" width={36} height={36} className="hover:scale-110 transition-transform duration-200" unoptimized />
            </a>
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <Image src="/icons/socials/4102573_applications_facebook_media_social_icon.png" alt="Facebook" width={36} height={36} className="hover:scale-110 transition-transform duration-200" unoptimized />
            </a>
          </div>
