export default function Head() {
  return (
    <>
      ...
      <meta name="twitter:title" content="SmartPro AI Solutions — AI Voice & Digital Agents for Business Automation" />
      <meta name="twitter:description" content="SmartPro AI Solutions: Voice and digital AI agents for business automation, cost reduction, and efficiency boost. Try a free demo!" />
